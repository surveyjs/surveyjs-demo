...
Today they still live at their historical paths: `src/lib/pdf-export.ts`, `src/lib/surveyjs-license.ts`, `src/components/analytics/` and `src/components/configure/CreatorPane.tsx`.
